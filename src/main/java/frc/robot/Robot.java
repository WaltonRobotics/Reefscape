/* NOTE: a lot of the methods we had in the button bindings now dont exist. ill go back and fix them as soon as im done fixing all the other issues in the classes themselves
 * but
 * the errors were bothering me so i killed robot.java for now.
 * also i commented out the line that calls robot.java in main. ill fix that too. 
 */
